...
export default function HistoryEdit({ history, errors = {} }: HistoryEditProps) {
    const { data, setData, put, processing, progress } = useForm({
        year: history.year || '',
        photo: history.photo || (null as File | null),
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-2xl font-bold tracking-tight">Edit History</CardTitle>
                        </CardHeader>
                        <CardContent>
