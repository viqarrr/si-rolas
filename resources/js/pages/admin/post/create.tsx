...
import { PostStatus, PostType, type BreadcrumbItem, type Post } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Postingan', href: '/postingan/create' },
];

export default function PostCreate({ type = PostType.NEWS, errors = {} }: PostCreateProps) {
